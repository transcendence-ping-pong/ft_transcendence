...
//       <button class="arrow-btn" id="arrowBtn" title="Close" tabindex="0" aria-label="Close"></button>
//     </div>
//     <div class="content">
//       <slot></slot>
//     </div>
//   </div>
// `;
// // <button class="arrow-btn" id="closeBtn" title="Close" tabindex="0" aria-label="Close">&#10005;</button>
