...
export class BabylonGUI {
  ...
  this.gameOverText.textHorizontalAlignment = Control.HORIZONTAL_ALIGNMENT_CENTER;
  this.gameOverText.textVerticalAlignment = Control.VERTICAL_ALIGNMENT_CENTER;
