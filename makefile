...
.PHONY: frontend-install frontend-dev frontend-dev-ip frontend-build frontend-preview backend-install backend-dev backend-dev-ip backend-test dev build a clean clean-db fresh-start